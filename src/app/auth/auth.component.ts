...
export class AuthComponent implements OnDestroy{
  ...
  private showErrorAlert(message: string) {
      ...
      const alertCoponentFactory = this.componentFactoryResolver.resolveComponentFactory(AlertComponent);
      const hostViewContainerRef = this.alertHost.viewContainerRef;
      hostViewContainerRef.clear();

      const componentRef =  hostViewContainerRef.createComponent(alertCoponentFactory);
